...
* **Descrição:** Estudo analítico utilizando um dataset do Kaggle para extração de insights de acordo com temas específicos. Além do desenvolvimento da análise em Python, o projeto conta com a criação de um banner visual e um artigo técnico detalhando as descobertas estruturadas com base nos dados.
...
| :--- | :--- | :--- |
| **1. Automação de Romaneios** | Generative AI, Prompt Engineering, Chat GPT (GPTS) | Engenharia de prompt analítico para identificação de blocos, validação de regras de negócio, extração para Excel e quebra automatizada de PDFs. |
